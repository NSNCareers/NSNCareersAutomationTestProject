...
namespace CoreFramework.Reporting
{
    public class ExtentReportsHelper
    {
        ...
        public void SetTestStatusFail(string base64ScreenCapture,string message)
        {
            ...
            AddTestFailureScreenshot(base64ScreenCapture);
        }
        private void AddTestFailureScreenshot(string base64ScreenCapture)
        {
